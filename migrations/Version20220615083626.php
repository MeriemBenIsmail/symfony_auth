 ...
 */
final class Version20220615083626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_role ADD CONSTRAINT FK_2DE8C6A3A44B56EA FOREIGN KEY (parent_role_id) REFERENCES user_role (id)');
